                ...
                <div className="left-area-mian">
                    ...
                    <div className="group-scroll">
                        <div className="group-main">
                            ...
                            <h2>All Things Qtees! Announcing Quirkies Giveaway Winner! Come Vibe!</h2>
                            ...
                            <div className="footer-main">
                                ...
                                <h3>recording artist . Producer . @hippielifekrew since 2011 TM (coming soon to web3)</h3>
                            </div>
                        </div>
                        ...
                        <div className="group-main group-main-color-1">
                            ...
                            <h2>VeeFriends/BookGames (in honor of @JeremyKnowsVf</h2>
                            <div className="profiles-main">
                                <div className="profiles-sub">
                                    <div className="profiles">
                                        <img src="/images/profile-image-1.png" alt="Profile Image"/>
                            ...
                            <div className="footer-main">
                                ...
                                <h3>YouTube: BizzyNFT, Discord: #VeeFriends, On the Front end of #web3 and riding the wave</h3>
                            </div>
                        </div>
                        ...
                        <div className="group-main group-main-color-2">
                            ...
                            <h2>ALCHEMIST MINT PARTY - CRYPTOSKULLS WEEK 10</h2>
                        ...
                        <div className="group-main group-main-color-3">
                            ...
                            <h2>We just announced Roadmap 2.0 - LETS Chat!</h2>
                            <div className="profiles-main">
                                <div className="profiles-sub">
                                    <div className="profiles">
                                        <img src="/images/profile-image-1.png" alt="Profile Image"/>
                            ...
                            <div className="footer-main">
                                ...
                                <h3>Collectible NFT batz created in LA by @OzzyOsbourne & @SutterSystems...</h3>
                            </div>
                        </div>
